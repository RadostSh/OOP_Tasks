...
double Triangle::getArea() const
{
    ...
    double sideB = getPointAtIndex(0).getDistance(getPointAtIndex(2));
    double sideC = getPointAtIndex(1).getDistance(getPointAtIndex(2));
...
bool Triangle::intersectWithCircle(const Circle* circle) const
{
    return circle->intersectWithTriangle(this);
}

bool Triangle::intersectWithRectangle(const Rectangle* rectangle) const
{
    std::cout << "Triangle::intersectWithRectangle" << std::endl;
    return true;
}

bool Triangle::intersectWithTriangle(const Triangle* triangle) const
{
    std::cout << "Triangle::intersectWithTriangle" << std::endl;
    return true;
}